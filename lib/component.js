...
tinto.Component.prototype.toString = function() {
  if (this._locator.id) {
    ...
    return 'an element matching selector "' + this._locator.selector + '" under ' +
      this._locator.parent.toString() + ' at index ' + (this._locator.index || 0);
  }
};
...
tinto.Component.prototype.find = function(selector) {
  return new ComponentCollection(tinto.Component, new Locator(this, selector));
};

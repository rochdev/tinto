...
// TODO: support count assertion automatic registration with ES6 getters
...
tinto.Component.prototype.getters = function(props) {
  getters(this, props).map(CountAssertion.register.bind(CountAssertion));
};
